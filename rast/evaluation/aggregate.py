...
REQUIRED_AGGREGATE_COLUMNS: tuple[str, ...] = (
    ...
    "scene_graph_vs_flat_feature_disagreement_count",
    "rast_vs_scene_graph_same_action_different_reason_count",
    "rast_vs_scene_graph_same_action_different_reason_rate",
    "scene_graph_trigger_edge_count",
    "rast_trigger_risk_token_count",
    "event_aware_trigger_event_count",
    ...
    "relation_token_count_total",
    "relation_token_count_avg",
    "relation_type_counts",
    "uncertainty_token_count_total",
    "uncertainty_token_count_avg",
    "uncertainty_type_counts",
    "high_uncertainty_count_total",
    "high_uncertainty_count_avg",
    "affordance_token_count_total",
    ...
    "scene_graph_decision_trace_coverage",
...
AGGREGATE_DEFAULTS: dict[str, Any] = {
    ...
    "near_agent_relation_threshold": 0.0,
    "near_path_relation_threshold": 0.0,
    "blocking_relation_threshold": 0.0,
    "classification_uncertainty_threshold": 0.5,
    "position_variance_threshold": 0.2,
    "occlusion_ratio_threshold": 0.5,
    "sensor_agreement_threshold": 0.6,
