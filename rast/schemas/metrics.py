...
class EpisodeSummary(RASTBaseModel):
    ...
    final_distance_to_goal: float | None = Field(default=None, ge=0, description="episode 종료 후 goal까지의 거리입니다.")
    ...
    object_list_vs_flat_feature_disagreement_count: int = Field(
        ge=0,
        description="Object List vs Flat Feature disagreement count입니다.",
    )
